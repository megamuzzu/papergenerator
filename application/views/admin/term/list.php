  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?php echo base_url()?>admin/term/addnew" class="addnewbtn">Add New</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
     ...
     jQuery(document).ready(function(){
         jQuery(document).on("change", ".statusBtn", function(){
          ...
          var value  = $(this).val();
            ...
            hitURL = "<?php echo base_url() ?>admin/term/statusChange",
            currentRow = $(this);
    ...
    jQuery(document).ready(function(){
         ...
         jQuery(document).on("click", ".deletebtn", function(){
          ...
          var userId = $(this).data("userid"),
            hitURL = "<?php echo base_url() ?>admin/term/delete",
            currentRow = $(this);
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/term/ajax_list')?>",
            "type": "POST"
        },
