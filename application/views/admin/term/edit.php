        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form role="form" action="<?php echo base_url() ?>admin/term/update" method="post" role="form" enctype="multipart/form-data">

                <div class="row mb-3">
                  <input type="hidden" name="id" value="<?php echo $edit_data->id;?>"/>
                  <label for="inputText" class="col-sm-2 col-form-label">Term Name</label>
                  <div class="col-sm-10">
                    <input type="text" name="term_name" class="form-control" value="<?php echo $edit_data->term_name;?>">
                  </div>
                </div>
