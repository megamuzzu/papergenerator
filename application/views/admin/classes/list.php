  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?php echo base_url()?>admin/classes/addnew" class="addnewbtn">Add New</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                <div class="card-body">
                  <h5 class="card-title">Class Data <span>| List</span></h5>
     ...
     jQuery(document).ready(function(){
         jQuery(document).on("change", ".statusBtn", function(){
          ...
          var value  = $(this).val();
            ...
            hitURL = "<?php echo base_url() ?>admin/classes/statusChange",
            currentRow = $(this);
    ...
    jQuery(document).ready(function(){
         ...
         jQuery(document).on("click", ".deletebtn", function(){
          ...
          var userId = $(this).data("userid"),
            hitURL = "<?php echo base_url() ?>admin/classes/delete",
            currentRow = $(this);
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/classes/ajax_list')?>",
            "type": "POST"
        },
